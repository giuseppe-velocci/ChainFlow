...
![Diagramma senza titolo drawio](https://github.com/giuseppe-velocci/ChainFlow/assets/42746122/de1ee06b-4a10-4f36-86b6-84c5bc38800e)
...
Here's a sample of markdown produced by above flow followed by an image preview:
```
## ConsoleWorkflow
...
:::
```
![immagine](https://github.com/giuseppe-velocci/ChainFlow/assets/42746122/42b8bfdf-5ff9-447b-bea1-abcd83c80f37)
